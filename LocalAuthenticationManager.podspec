#
# Be sure to run `pod lib lint LocalAuthenticationManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'LocalAuthenticationManager'
  s.version          = '0.1.0'
  s.summary          = 'A short description of LocalAuthenticationManager.'
